...
- Agent 2 uses research context + persona to select the most diagnostic questions; count is explicit from pillar config; falls back to rule-based if LLM fails
