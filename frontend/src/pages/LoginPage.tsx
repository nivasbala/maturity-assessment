  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center">
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 w-full max-w-sm">
        <h1 className="text-2xl font-bold text-[#1B2B4B] mb-1">Sign in</h1>
        <p className="text-sm text-gray-500 mb-6">Maturity Assessment Platform</p>

        {error && (
          <div className="mb-4 px-3 py-2 rounded bg-red-50 text-red-700 text-sm border border-red-200">
            {error}
          </div>
        )}
