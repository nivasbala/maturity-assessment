...
function ScoreSection({ report, s, brand }: { report: Report; s: Styles; brand: string }) {
...
export function InternalReportPdf({ answers, report, darkMode = false, brandColor = '#3d6ea8' }: Props) {
